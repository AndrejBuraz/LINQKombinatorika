...
namespace KombinatorikaLINQ
{
    internal class Program
    {
        ...
        {
            int[] br = new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
            var query = from br1 in br
                from br2 in br
                where br2 != br1 && (br1 * 10 + br2) % 2 == 0
                from br3 in br
                where br3 != br2 && br3 != br1 && (br1 * 100 + br2 * 10 + br3) % 3 == 0
                from br4 in br
                where br4 != br3 && br4 != br2 && br4 != br1 && (br1 * 1000 + br2 * 100 + br3 * 10 + br4) % 4 == 0
                from br5 in br
                where br5 != br4 && br5 != br3 && br5 != br2 && br5 != br1 && (br1 * 10000 + br2 * 1000 + br3 * 100 + br4 * 10 + br5) % 5 == 0
                from br6 in br
                ...
                let broj = br1 * 100000000 + br2 * 10000000 + br3 * 1000000 + br4 * 100000 + br5 * 10000 + br6 * 1000 +
                             br7 * 100 + br8 * 10 + br9 * 1
                where broj % 9 == 0
                select broj;
